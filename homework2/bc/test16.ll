...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 (i32, i32)* @clever1(i32 %a, i32 %b, i32 (i32, i32)* %a_fptr, i32 (i32, i32)* %b_fptr) #0 !dbg !57 {
entry:
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
  %a_fptr.addr = alloca i32 (i32, i32)*, align 8
  ...
  store i32 (i32, i32)* %a_fptr, i32 (i32, i32)** %a_fptr.addr, align 8
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %a_fptr.addr, metadata !62, metadata !DIExpression()), !dbg !63
  store i32 (i32, i32)* %b_fptr, i32 (i32, i32)** %b_fptr.addr, align 8
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %b_fptr.addr, metadata !64, metadata !DIExpression()), !dbg !65
  %0 = load i32, i32* %a.addr, align 4, !dbg !66
  %1 = load i32, i32* %b.addr, align 4, !dbg !67
  %2 = load i32 (i32, i32)*, i32 (i32, i32)** %b_fptr.addr, align 8, !dbg !68
  %3 = load i32 (i32, i32)*, i32 (i32, i32)** %a_fptr.addr, align 8, !dbg !69
  %call = call i32 (i32, i32)* @clever(i32 %0, i32 %1, i32 (i32, i32)* %2, i32 (i32, i32)* %3), !dbg !70
  ret i32 (i32, i32)* %call, !dbg !71
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @moo(i8 signext %x, i32 %op1, i32 %op2) #0 !dbg !72 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8* %x.addr, metadata !76, metadata !DIExpression()), !dbg !77
  store i32 %op1, i32* %op1.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %op1.addr, metadata !78, metadata !DIExpression()), !dbg !79
  store i32 %op2, i32* %op2.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %op2.addr, metadata !80, metadata !DIExpression()), !dbg !81
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %a_fptr, metadata !82, metadata !DIExpression()), !dbg !83
  store i32 (i32, i32)* @plus, i32 (i32, i32)** %a_fptr, align 8, !dbg !83
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %s_fptr, metadata !84, metadata !DIExpression()), !dbg !85
  store i32 (i32, i32)* @minus, i32 (i32, i32)** %s_fptr, align 8, !dbg !85
  call void @llvm.dbg.declare(metadata i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, metadata !86, metadata !DIExpression()), !dbg !88
  store i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* @clever1, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !88
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %t_fptr, metadata !89, metadata !DIExpression()), !dbg !90
  %0 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !91
  %1 = load i32, i32* %op1.addr, align 4, !dbg !92
  %2 = load i32, i32* %op2.addr, align 4, !dbg !93
  %3 = load i32 (i32, i32)*, i32 (i32, i32)** %s_fptr, align 8, !dbg !94
  %4 = load i32 (i32, i32)*, i32 (i32, i32)** %a_fptr, align 8, !dbg !95
  %call = call i32 (i32, i32)* %0(i32 %1, i32 %2, i32 (i32, i32)* %3, i32 (i32, i32)* %4), !dbg !91
  store i32 (i32, i32)* %call, i32 (i32, i32)** %t_fptr, align 8, !dbg !90
  %5 = load i32 (i32, i32)*, i32 (i32, i32)** %t_fptr, align 8, !dbg !96
  %6 = load i32, i32* %op1.addr, align 4, !dbg !97
  %7 = load i32, i32* %op2.addr, align 4, !dbg !98
  %call1 = call i32 %5(i32 %6, i32 %7), !dbg !96
  ret i32 0, !dbg !99
}
...
!1 = !DIFile(filename: "test16.c", directory: "/home/llvm_10/homework2/homework2/test")
!2 = !{}
...
!57 = distinct !DISubprogram(name: "clever1", scope: !1, file: !1, line: 16, type: !29, scopeLine: 16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!58 = !DILocalVariable(name: "a", arg: 1, scope: !57, file: !1, line: 16, type: !10)
!59 = !DILocation(line: 16, column: 19, scope: !57)
!60 = !DILocalVariable(name: "b", arg: 2, scope: !57, file: !1, line: 16, type: !10)
!61 = !DILocation(line: 16, column: 26, scope: !57)
!62 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !57, file: !1, line: 16, type: !31)
!63 = !DILocation(line: 16, column: 35, scope: !57)
!64 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !57, file: !1, line: 16, type: !31)
!65 = !DILocation(line: 16, column: 59, scope: !57)
!66 = !DILocation(line: 17, column: 18, scope: !57)
!67 = !DILocation(line: 17, column: 20, scope: !57)
!68 = !DILocation(line: 17, column: 22, scope: !57)
!69 = !DILocation(line: 17, column: 29, scope: !57)
!70 = !DILocation(line: 17, column: 11, scope: !57)
!71 = !DILocation(line: 17, column: 4, scope: !57)
!72 = distinct !DISubprogram(name: "moo", scope: !1, file: !1, line: 19, type: !73, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!73 = !DISubroutineType(types: !74)
!74 = !{!10, !75, !10, !10}
!75 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!76 = !DILocalVariable(name: "x", arg: 1, scope: !72, file: !1, line: 19, type: !75)
!77 = !DILocation(line: 19, column: 14, scope: !72)
!78 = !DILocalVariable(name: "op1", arg: 2, scope: !72, file: !1, line: 19, type: !10)
!79 = !DILocation(line: 19, column: 21, scope: !72)
!80 = !DILocalVariable(name: "op2", arg: 3, scope: !72, file: !1, line: 19, type: !10)
!81 = !DILocation(line: 19, column: 30, scope: !72)
!82 = !DILocalVariable(name: "a_fptr", scope: !72, file: !1, line: 20, type: !31)
!83 = !DILocation(line: 20, column: 11, scope: !72)
!84 = !DILocalVariable(name: "s_fptr", scope: !72, file: !1, line: 21, type: !31)
!85 = !DILocation(line: 21, column: 11, scope: !72)
!86 = !DILocalVariable(name: "goo_ptr", scope: !72, file: !1, line: 22, type: !87)
!87 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !29, size: 64)
!88 = !DILocation(line: 22, column: 14, scope: !72)
!89 = !DILocalVariable(name: "t_fptr", scope: !72, file: !1, line: 24, type: !31)
!90 = !DILocation(line: 24, column: 11, scope: !72)
!91 = !DILocation(line: 24, column: 30, scope: !72)
!92 = !DILocation(line: 24, column: 38, scope: !72)
!93 = !DILocation(line: 24, column: 43, scope: !72)
!94 = !DILocation(line: 24, column: 48, scope: !72)
!95 = !DILocation(line: 24, column: 56, scope: !72)
!96 = !DILocation(line: 25, column: 5, scope: !72)
!97 = !DILocation(line: 25, column: 12, scope: !72)
!98 = !DILocation(line: 25, column: 17, scope: !72)
!99 = !DILocation(line: 27, column: 5, scope: !72)
